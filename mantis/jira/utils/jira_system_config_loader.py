...
class CreatemetaModelFactory:
    ...
    def create_model(self) -> None:
        ...
        outer_schema_with_nested_fields = {
            "key": str,
            "id": str,
            "fields": fields_model,
        }
    ...
    def assign_python_type(self, meta: JiraIssueFieldSchema, meta_field_key: str):
    ...
    def assign_attributes_and_getters(
        self, meta: JiraIssueFieldSchema, meta_field_key: str
    ):
    ...
    def _add_aliases_for_custom_fields(self, fields_model: type[BaseModel]):
